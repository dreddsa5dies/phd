...
\newcommand{\theTypesetter}{\fixme{В. В. Соловьев}}
\newcommand{\thePrintDate}{\fixme{8.08.2026}}
\newcommand{\thePrintSheets}{1,6}
...
\small
\begin{center}
    Компьютерная верстка \theTypesetter
    \par\medskip

    Подписано к печати \thePrintDate. Формат 60\(\times\)84 \sfrac{1}{16}. Бумага офсетная.
    \par
    Усл. печ. л. \thePrintSheets. Тираж \thePrintRun\ экз. Заказ \thePrintOrder.
    \par\bigskip
